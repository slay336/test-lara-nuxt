<template>
  <div class="relative min-h-[100vh] flex flex-col before:content-[''] before:absolute before:top-0 before:left-0 before:w-full before:h-full before:bg-gradient-to-r before:from-black/90 before:to-black/70">
    ...
    <header>
      <div class="py-[15px] px-0">
        <div class="px-[25px] flex justify-between items-center">
          ...
          <div class="flex justify-between grow">
            ...
            >
              <font-awesome-icon
                class="mr-[5px] bg-sky-300 w-[35px] h-[35px] flex justify-center items-center text-white rounded-full hover:bg-teal-600"
            ...
            <a
              class="text-white flex items-center justify-cente"
              href=""
            >
              <font-awesome-icon
                class="mr-[5px] bg-sky-300 w-[35px] h-[35px] flex justify-center items-center text-white rounded-full hover:bg-teal-600"
          ...
          <div class="flex justify-end min-w-[200px]">
            <a href="">
              <font-awesome-icon
                class="mr-5 bg-sky-400 w-[28px] h-[28px] flex justify-center items-center text-white rounded-full hover:bg-teal-600"
        ...
        <div class="row">
          ...
          <div class="col-md-5 ">
            <div class="info_contact">
              <a href="">
                <font-awesome-icon icon="fa fa-map-marker" />
                <span>
                  Location
                </span>
              </a>
